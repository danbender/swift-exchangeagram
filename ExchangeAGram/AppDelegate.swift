...
//        automatically purge cache if you receive memory warning.
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "net.danbender.ExchangeAGram" in the application's documents Application Support directory.
